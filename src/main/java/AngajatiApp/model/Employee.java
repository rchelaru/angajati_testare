...
public class Employee {
	...
	public boolean equals(Object otherEmployee) {
		...
		boolean		hasSameLastName  = this.nume.equals(employee.getLastName());
		boolean		hasSameCNP       = this.cnp.equals(employee.getCnp());
		boolean		hasSameFunction  = this.function.equals(employee.getFunction());
		boolean		hasSameSalary    = this.salary.equals(employee.getSalary());
